...
<p align="center">
  ...
  <a href="https://github.com/Jarnpher553/nuclei/blob/main/README_KR.md">한국어</a> •
  <a href="https://github.com/Jarnpher553/nuclei/blob/main/README_ES.md">스페인어</a>
</p>
...
Nuclei는 [v2.5.2](https://github.com/Jarnpher553/nuclei/releases/tag/v2.5.2)부터 자동 템플릿 다운로드/업데이트를 기본으로 지원합니다.
...
Thanks to all the amazing community [contributors for sending PRs](https://github.com/Jarnpher553/nuclei/graphs/contributors). Do also check out the below similar open-source projects that may fit in your workflow:
