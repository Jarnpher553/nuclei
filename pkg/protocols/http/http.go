...
import (
	...
	"github.com/Jarnpher553/nuclei/v3/pkg/fuzz"
	...
	httputil "github.com/Jarnpher553/nuclei/v3/pkg/protocols/utils/http"
...
type Request struct {
	...
	// Deprecated: request condition will be detected automatically (https://github.com/Jarnpher553/nuclei/issues/2393)
...
func (request *Request) Compile(options *protocols.ExecutorOptions) error {
	...
	if len(request.Payloads) > 0 {
		// Due to a known issue (https://github.com/Jarnpher553/nuclei/issues/5015),
