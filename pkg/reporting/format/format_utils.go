...
import (
	...
	"github.com/Jarnpher553/nuclei/v3/pkg/reporting/exporters/markdown/util"
...
func CreateReportDescription(event *output.ResultEvent, formatter ResultFormatter, omitRaw bool) string {
	...
	builder.WriteString(fmt.Sprintf("Generated by %s", formatter.CreateLink("Nuclei "+config.Version, "https://github.com/Jarnpher553/nuclei")))
	data := builder.String()
	return data
}
